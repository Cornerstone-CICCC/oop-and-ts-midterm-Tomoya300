...
export class CartList extends Component {
  ...
  handleUpdateTotalItems() {
    ...
    this.miniTotalItems.innerHTML = ''
    this.miniTotalItems.innerHTML = this.props.cartContext.totalItems
  }
  ...
  render() {
    ...
    cartElement.innerHTML = `
      <div class='cart-icon'>
        <div class='icon-box'>
          <div class='mini-total-box'>
            <p class='mini-total-items'>0</p>
          </div>
    ...
    cartElement.querySelector('.cart-icon').addEventListener('click', () => {
      if (cartElement.querySelector('.cart-main').classList.contains('hidden')) {
        cartElement.querySelector('.cart-main').classList.remove('hidden')
      } else {
        cartElement.querySelector('.cart-main').classList.add('hidden')
      }
    })
    ...
    this.miniTotalItems = cartElement.querySelector('.mini-total-items')
